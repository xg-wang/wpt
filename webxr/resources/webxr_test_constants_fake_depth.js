...
// Let's assume that the above values are in cm, Xcm = x * 1/100m
const rawValueToMeters = 1/100;

const depthSensingData = {
  ...
  rawValueToMeters: rawValueToMeters,
};
...
const getExpectedValueAt = function(column, row) {
  return Math.pow(column+1, row) * rawValueToMeters;
};
